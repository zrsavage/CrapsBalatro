...
export const DICE_CATALOG: DieDef[] = [
  ...
  {
    id: 'double_wild',
    name: 'Double Wild Die',
    description: 'Two faces are Wild, resolving to whatever value helps your bets most.',
  ...
  },
  {
    id: 'boxcars',
    name: 'Boxcars Die',
    description: 'Heavily favors 6, great for Field and Place 6/8.',
    faces: [3, 4, 6, 6, 6, 6],
    price: 8,
    rarity: 'uncommon',
  },
  {
    id: 'snake_eyes',
    name: 'Snake Eyes Die',
    description: 'Heavily favors 1, great for Any Craps and Don’t bets.',
    faces: [1, 1, 1, 1, 3, 5],
    price: 8,
    rarity: 'uncommon',
  },
